...
import { Session, createInMemoryFtKeyStore, createKeyStoreInteractor, createWeb3ProviderEvmKeyStore } from "@chromia/ft4";
import { createClient, newSignatureProvider } from "postchain-client";
import { ReactNode, createContext, useContext, useEffect, useState } from "react";

// Create two contexts for Chromia and EVM wallet
